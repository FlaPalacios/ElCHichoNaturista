...
**El café `#1C1919`.** Acento de contraste, con cuentagotas: los titulares, el
botón de «agregar al carrito» (en las tarjetas y en la ficha), el contador del
carrito y la banda de cierre de la portada. El verde salvia sigue siendo el
color de marca; el café solo sirve para que la acción de compra salte a la
vista. Los botones llevan una curva ligera de 5px (`--radio`).
